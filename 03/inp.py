inputData = """NLBLfrNNLvqwbMfDqSjSzzSJjjggcdVs
...
# join each 3 lines into a single line
inputData = inputData.split()
inputData_b = [inputData[i:i+3] for i in range(0, len(inputData), 3)]

inputData = [(x[:len(x)//2], x[len(x)//2:]) for x in inputData]